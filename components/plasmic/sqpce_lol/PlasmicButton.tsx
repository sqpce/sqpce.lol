...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 6R42nZZIlShc/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: vYbZy2p1bmTJ/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: kpZ4e4cawOY8/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nm0Ch)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__vddhi)}
                role={"img"}
              />
            ),
